...
class Alias(models.Model):
    ...
    label = models.CharField(
        max_length=100, db_column='etiqueta',
        help_text="Etiqueta: ej. Amazon, Foro Reddit",
    )
    address = models.EmailField(
        unique=True, db_column='direccion',
    ...
    destroyed_at = models.DateTimeField(null=True, blank=True, db_column='destruido_en')
...
class AliasQuotaRequest(models.Model):
    ...
    id = models.AutoField(primary_key=True, db_column='id_solicitud_cupo')
    user = models.ForeignKey(
    ...
    granted_amount = models.PositiveIntegerField(
        default=0, db_column='cantidad_concedida',
